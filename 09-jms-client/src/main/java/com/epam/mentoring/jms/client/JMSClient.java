package com.epam.mentoring.jms.client;
...
public class JMSClient {
	...
	private static final String MENU_OPTION_1 = "Press '1' to write message";
	...
	public void sendAsync(final String text) throws JMSException,
			NamingException {
